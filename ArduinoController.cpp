...
void ArduinoController::setTurbine( int a, int* data ) {
	turbine = a;
	data[1] = a;
}
...
void ArduinoController::driveController( float E, int base, int* data ) {
	// PID controller
	intG += E*0.2f;
	if ( intG>3 ) intG = 3;
	if ( intG<-3 ) intG = -3;
...
void ArduinoController::setMotors( int leftM, int rightM, int* data ) {
